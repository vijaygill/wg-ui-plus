    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upstream_dns_ip_address', models.CharField(max_length=255, validators=[api_app.models.validator_is_single_address])),
                ('local_networks', models.CharField(blank=True, max_length=512, null=True, validators=[api_app.models.validator_are_network_addresses])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disabled', models.BooleanField(default=False, null=True)),
                ('ip_address', models.CharField(max_length=255, validators=[api_app.models.validator_is_network_or_single_address])),
                ('port', models.IntegerField(blank=True, null=True)),
                ('allow_modify_self', models.BooleanField(default=True, null=True)),
