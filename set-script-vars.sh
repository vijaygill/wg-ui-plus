...
DOCKER_RUN_CMD="${DOCKER_RUN_CMD} -e EMAIL_HOST=cm3588-nas-01.gillsoft.home"
DOCKER_RUN_CMD="${DOCKER_RUN_CMD} -e EMAIL_PORT=9025"
DOCKER_RUN_CMD="${DOCKER_RUN_CMD} -e EMAIL_DEFAULT_FROM_EMAIL=pi@cm3588-nas-01.gillsoft.home"
